...
const TITLE =
  "Stan Store Fees: $29/mo, 0% Sales Fee, the Real 12-Month Cost (2026)";
const DESCRIPTION =
  "Stan Store charges $29/month and takes 0% of sales. See the real 12-month cost at $500, $2k and $5k/month versus Gumroad and Beacons percentage fees, and how it compares to Creatdrop's flat $29/mo, $0-per-sale model.";
const URL = "https://creatdrop.com/compare/stan-store-fees";
...
export default function StanStoreFeesComparison() {
  return (
    <main className="min-h-screen bg-white">
      <BlogArticleSchema
        ...
        breadcrumbs={[{ name: "Compare", url: "https://creatdrop.com/compare" }, { name: "Stan Store fees", url: URL }]}
      />
      {/* Nav */}
      ...
      <article className="mx-auto max-w-2xl px-6 py-12 sm:py-16">
        ...
        <nav className="mb-8 text-sm text-slate-500">
          ...
          <span className="text-slate-800">Stan Store fees</span>
        </nav>

        <h1 className="mb-4 text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">
          Stan Store fees: what $29/month and 0% really costs
        </h1>

        <p className="mb-10 text-base text-slate-500">
          Stan Store charges a flat $29/month and takes 0% of sales. Here is the
          side-by-side against Gumroad and Beacons percentage fees, at three
          revenue levels, with the breakeven stated plainly.
        </p>
