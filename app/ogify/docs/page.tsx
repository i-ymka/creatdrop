      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-zinc-100">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link href="/ogify" className="text-sm font-bold text-zinc-500 hover:text-zinc-900 transition-colors">
              OGify
            </Link>
            <span className="text-zinc-300">/</span>
          ...
          <Link
            href="/sign-up"
            className="px-4 py-2 rounded-full bg-violet-600 text-white text-sm font-black hover:bg-violet-700 transition-colors shadow-md shadow-violet-200"
          >
            Get started free
          </Link>
        </div>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-16">
        ...
        <div className="mt-16 pt-10 border-t border-zinc-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <p className="text-sm text-zinc-500">
            Need help?{" "}
            <a
              href="mailto:support@creatdrop.com"
          ...
          <div className="flex items-center gap-4">
            <Link href="/ogify" className="text-sm font-semibold text-zinc-500 hover:text-zinc-900 transition-colors">
              ← OGify home
            </Link>
            <Link
              href="/ogify/dashboard"
