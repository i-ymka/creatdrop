...
import { startWaitlistCheckout } from "@/app/(dashboard)/dashboard/actions";

export function WaitlistUpgradeButton() {
  ...
  useEffect(() => {
    ...
    initializePaddle({ token, environment: "production" })
      ...
      .catch((e) => {
        console.error("[WaitlistUpgradeButton] Paddle init failed", e);
