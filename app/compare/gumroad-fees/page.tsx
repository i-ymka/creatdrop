...
const TITLE =
  "Gumroad Fees: What 10% of Every Sale Actually Costs You (2026)";
const DESCRIPTION =
  "Gumroad charges 10% of every sale with no monthly fee. See the real 12-month cost at $500, $2k and $5k/month versus flat $29/mo, 0% platforms like Stan and Creatdrop, including where Gumroad is actually the cheaper choice.";
const URL = "https://creatdrop.com/compare/gumroad-fees";
...
export default function GumroadFeesComparison() {
  return (
    <main className="min-h-screen bg-white">
      <BlogArticleSchema
        ...
        breadcrumbs={[{ name: "Compare", url: "https://creatdrop.com/compare" }, { name: "Gumroad fees", url: URL }]}
      />
      {/* Nav */}
      ...
      <article className="mx-auto max-w-2xl px-6 py-12 sm:py-16">
        ...
        <nav className="mb-8 text-sm text-slate-500">
          ...
          <span className="text-slate-800">Gumroad fees</span>
        </nav>

        <h1 className="mb-4 text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">
          Gumroad fees: what 10% of every sale actually costs you
        </h1>

        <p className="mb-10 text-base text-slate-500">
          Gumroad takes 10% of every sale and charges no monthly fee, so the
          cost never shows up as a bill. Here is the side-by-side against flat
