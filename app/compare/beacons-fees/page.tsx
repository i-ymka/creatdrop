...
const TITLE =
  "Beacons Fees: What 9% of Every Sale Actually Costs You (2026)";
const DESCRIPTION =
  "Beacons charges 9% of every sale on its standard tier with no monthly fee. See the real 12-month cost at $500, $2k and $5k/month versus flat $29/mo, 0% platforms like Stan and Creatdrop, including where Beacons is the cheaper choice.";
const URL = "https://creatdrop.com/compare/beacons-fees";
...
const AT_A_GLANCE: { platform: string; fee: string; perSale: string; model: string }[] = [
  { platform: "Beacons (standard)", fee: "$0", perSale: "9%", model: "Percentage" },
  { platform: "Beacons (Store Pro)", fee: "~$30/mo", perSale: "0%", model: "Flat" },
...
export default function BeaconsFeesComparison() {
  return (
    <main className="min-h-screen bg-white">
      <BlogArticleSchema
        ...
        breadcrumbs={[{ name: "Compare", url: "https://creatdrop.com/compare" }, { name: "Beacons fees", url: URL }]}
      />
      {/* Nav */}
      ...
      <article className="mx-auto max-w-2xl px-6 py-12 sm:py-16">
        ...
        <nav className="mb-8 text-sm text-slate-500">
          ...
          <span className="text-slate-800">Beacons fees</span>
        </nav>

        <h1 className="mb-4 text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">
          Beacons fees: what 9% of every sale actually costs you
        </h1>

        <p className="mb-10 text-base text-slate-500">
          Beacons takes 9% of every sale on its standard tier and charges no
          monthly fee, so the cost never shows up as a bill. Here is the
          side-by-side against flat $29/mo, 0% platforms, at three revenue
        ...
        <div className="prose prose-slate max-w-none text-[17px] leading-relaxed text-slate-700 space-y-6">
          ...
          <p>
            Beacons also sells a Store Pro tier at about $30/mo with 0% fees. At
            that point it is itself a flat ~$30/mo product, the same model
            argued for here.
          </p>
          ...
          <p>
            ...
            cheaper while you are small. Below roughly $322/month in sales,
            Beacons&apos; 9% costs less than a $348/year flat fee, and we are not
            going to pretend otherwise. The point is what happens after you
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              in sales, roughly <strong>$322/month</strong>. Below that, Beacons
          ...
          <p className="text-sm text-slate-500">
            Beacons: 9% on the standard tier, plus a Store Pro tier at about
            $30/month with 0%, compiled from Beacons' publicly listed pricing (verify current rates
            before relying on them).
            Figures exclude payment processing (Stripe/PayPal, about 2.9% +
            $0.30/sale), which is similar on every platform. Beacons&apos; Store
            Pro tier removes the 9% for about $30/month, at which point it is a
            flat-fee product.
          </p>
